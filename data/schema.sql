...
(1,"Kentucky Owl Batch #8 Straight Bourbon","Bourbon di alta gamma noto per la sua complessità aromatica con note di caramello, spezie e quercia. Prodotto in piccoli lotti numerati.",320,50.0,"USA","bourbon/kentucky-owl-batch-8.jpg",10,20,0.7,"kentucky-owl-batch-8",NOW()),
...
(1,"WhistlePig 15 Years Old Rye Whiskey - Vermont Estate Oak","Rye whiskey invecchiato 15 anni e rifinito in botti di quercia del Vermont. Offre note di spezie, miele e legno tostato.",350,46.0,"USA","bourbon/whistlepig-15-years-old.jpg",15,10,0.7,"whistlepig-15-years-old",NOW());
...
(2,"Midleton Dair Ghaelach Virgin Oak - Tree 7","Edizione speciale Midleton maturata in botti di quercia irlandese vergine provenienti dalla foresta di Grinsell. Complesso e speziato.",260,56,"Ireland","irish/midleton-dair-ghaelach-tree7.jpg",15,5,0.7,"midleton-dair-ghaelach-tree7",NOW()),
...
(3,"Shizuoka Contact S Japanese Whisky","Blended malt della giovane distilleria Shizuoka. Combina whisky giapponesi con whisky scozzesi per un profilo equilibrato.",160,55,"Japan","japanese/shizuoka-contact-s.jpg",5,10,0.7,"shizuoka-contact-s",NOW()),
...
(3,"Taketsuru 21 Years Old","Blended malt dedicato al fondatore di Nikka, Masataka Taketsuru. Elegante e complesso con note di frutta secca e torba.",500,43,"Japan","japanese/taketsuru-21-years-old.jpg",21,15,0.7,"taketsuru-21-years-old",NOW()),
...
INSERT INTO products (category_id, name, description, price, alcol, origin, img, age, discount, liters, slug, created_at)
VALUES
(4,"Glenglassaugh 47 Years Old 1968 - Rare Cask Batch 3","Single malt estremamente raro distillato nel 1968 e imbottigliato dopo 47 anni di maturazione.",9500,42,"Scotland","scotch/glenglassaugh-47-years-old.jpg",47,10,0.7,"glenglassaugh-47-years-old",NOW()),
...
(4,"Laphroaig 34 Years Old Ian Hunter Book 5","Edizione ultra limitata della serie Ian Hunter. Torbato elegante con lunghissimo invecchiamento.",2200,46,"Scotland","scotch/laphroaig-34yo.jpg",34,5,0.7,"laphroaig-34yo",NOW()),
